...
export const SectionFour = () => {
	return (
		<section className="mt-10 flex justify-center items-center flex-row gap-60 text-text-50 bg-bg-50 dark:text-text-950 dark:bg-bg-950">
			<article className="">
			...
			<div className="md:grid-cols-2 md:grid-rows-2 gap-2 grid">
				<Image alt="imaga" src="/landing-1.webp" width={190} isZoomed />
				<Image alt="imaga" src="/landing-1.webp" width={190} isZoomed />
