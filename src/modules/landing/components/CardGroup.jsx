	...
	return (
		<div className="flex flex-col md:flex-row md:gap-x-16  gap-y-16 justify-center items-center m-10 ">
			...
			<CardLanding>
				...
				<p className="m-4 font-normal text-[#F2F2F2] text-xs">Ajusta cada aspecto según tus necesidades específicas.</p>
			</CardLanding>

			<CardLanding>
				<Users color="#26A9D9" className="m-2" />
				<h4 className="m-4 text-[#F2F2F2] font-bold">Gestiona Asistentes</h4>
				<p className="m-4 font-normal text-[#F2F2F2] text-xs">Administra registros y comunicaciones fácilmente.</p>
			</CardLanding>
		</div>
	);
};
